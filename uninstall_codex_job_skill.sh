...
usage() {
  cat <<'USAGE'
Usage:
  uninstall_codex_job_skill.sh --scope <project|user|global> [options]
...
Examples:
  uninstall_codex_job_skill.sh --scope user
  uninstall_codex_job_skill.sh --scope user --dry-run
  uninstall_codex_job_skill.sh --scope project --no-profile
USAGE
}
